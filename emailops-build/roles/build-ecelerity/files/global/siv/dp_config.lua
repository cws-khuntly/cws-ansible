...
--[[
  {
    ...
    type = "rbldnsd",
    refresh = 1800,
    source = "/opt/msys/ecelerity/etc/conf/default/whitelist.txt",
    record_type = "TXT",
    default_value = "",
  },
]]
  {
    ...
    refresh = 1800,
    cachename = "cidr",
    query = "SELECT 1 as val, cidr FROM ec_global_wl_ips",
    cidr_column = "cidr",
    value_column = "val",
    default_value = "",
  },
  {
    ...
    refresh = 1800,
    cachename = "cidr",
    query = "SELECT 1 as val, cidr FROM ec_internal_ips",
    cidr_column = "cidr",
    value_column = "val",
    default_value = "",
  },
  {
    ...
    refresh = 1800,
    cachename = "cidr",
    query = "SELECT 1 as val, cidr FROM ec_dha_wl_ips",
    cidr_column = "cidr",
    value_column = "val",
    default_value = "",
  },
  {
    ...
    refresh = 1800,
    cachename = "cidr",
    query = "SELECT 1 as val, cidr FROM ec_rbl_wl_ips",
    cidr_column = "cidr",
    value_column = "val",
    default_value = "",
  },
  {
    ...
    refresh = 1800,
    cachename = "cidr",
    query = "SELECT 1 as val, cidr FROM ec_fcdns_wl_ips",
    cidr_column = "cidr",
    value_column = "val",
    default_value = "",
  },
  {
    ...
    refresh = 1800,
    cachename = "cidr",
    query = "SELECT 1 as val, cidr FROM ec_conn_wl_ips",
    cidr_column = "cidr",
    value_column = "val",
    default_value = "",
  },
  {
    ...
    refresh = 1800,
    cachename = "cidr",
    query = "SELECT 1 as val, cidr FROM ec_auth_wl_ips",
    cidr_column = "cidr",
    value_column = "val",
    default_value = "",
  },
  {
    ...
    refresh = 1800,
    cachename = "cidr",
    query = "SELECT 1 as val, cidr FROM ec_content_wl_ips",
    cidr_column = "cidr",
    value_column = "val",
    default_value = "",
  },
  {
    ...
    refresh = 1800,
    cachename = "cidr",
    query = "SELECT 1 as val, cidr FROM ec_dmarc_wl_ips",
    cidr_column = "cidr",
    value_column = "val",
    default_value = "",
  }
...
msys.dp_config.rbls = {
  {
    ...
    name = "xbl",
    type = "dns",
    base = "xbl.spamhaus.org",
    record_type = "TXT",
    code = 554,
    reason = "RBL hit on myrbl: %s",
    process_result = function (ac, vctx, info)
      return vctx:pbp_disconnect(554, "5.7.1 RBL Restriction: " .. info);
    end,
    honor_whitelist = { "global", "rbl" },
  },
  {
    check = true,
    name = "sbl",
    type = "dns",
    base = "sbl.spamhaus.org",
    record_type = "TXT",
    code = 554,
    reason = "RBL hit on myrbl: %s",
    process_result = function (ac, vctx, info)
  ...
  },
  {
    ...
    name = "pbl",
    type = "dns",
    base = "pbl.spamhaus.org",
    record_type = "TXT",
    code = 554,
    reason = "RBL hit on myrbl: %s",
    process_result = function (ac, vctx, info)
      return vctx:set(msys.core.VCTX_CONN, 'pbl', 'true')
    end,
    honor_whitelist = { "global", "rbl" },
  },
  {
    ...
    record_type = "A",
    code = 554,
    reason = "5.7.1 RBL Restriction: Blacklisted by Internal Reputation Service - %s",
    honor_whitelist = { "global", "rbl" },
  },
--[[
  { 
  ...
  },
  {
    ...
    name = "myrbl2",
    type = "rbldnsd",
    source = "/opt/msys/ecelerity/etc/conf/global/myrbldnsd.txt",
    refresh = 1800,
    record_type = "A",
    code = 451,
...
msys.dp_config.fcdns = {
  ...
  honor_whitelist = { "global", "internal", "fcdns" },
};

-- Concurrent connection limiting
msys.dp_config.concurrent_connection_limits = {
  { check = false,
    family = msys.core.AF_INET,
    mask = "/32",
    limit = 100,
    service = "SMTP",
    honor_whitelist = { "global", "internal", "conn" },
  }, 
  { check = false,
    family = msys.core.AF_INET,
    mask = "/24",
...
msys.dp_config.audit_series.mailfrom = {
  ...
  thresholds = {
    { check = true,
      ...
      endv = 3,
      threshold = 1000,
      honor_whitelist = { "global", "internal" } 
    }
  },
  options = {
    persist = true
...
msys.dp_config.relay_authorization = {
  ...
  onnet = {
    type = "rbldnsd",
    refresh = 1800,
    source = "/opt/msys/ecelerity/etc/conf/global/onnet.txt",
    record_type = "TXT",
    default_value = "",
  };
  ]]
  ...
  onnet = {
    ...
    refresh = 1800,
    cachename = "cidr",
    query = "SELECT 1 as val, cidr FROM ec_relays_ips",
    cidr_column = "cidr",
    value_column = "val",
    default_value = "",
  };
...
msys.dp_config.audit_series.invalid_recipients = {
  ...
  thresholds = {
    { check = true,
      ...
      endv = 3,
      threshold = 50, 
      honor_whitelist = { "global", "internal", "dha" } },
    { check = true,
      key = "/24",
      startv = 0,
      endv = 3,
...
msys.dp_config.audit_series.spam = {
  ...
  thresholds = {
    { check = true,
      ...
      endv = 3,
      threshold = 50,
      honor_whitelist = { "global", "internal", "content" } },
    { check = true,
      key = "/24",
      startv = 0,
      endv = 3,
...
-- https://support.messagesystems.com/docs/web-ref3/lua.ref.msys.symantec_beik.scan.php
--[[
...
-- documented here: https://support.messagesystems.com/docs/web-ref3/lua.ref.msys.commtouch.diagnose.php
--[[
...
-- documented here: https://support.messagesystems.com/docs/web-ref3/lua.ref.msys.cloudmark.score.php
--[[
